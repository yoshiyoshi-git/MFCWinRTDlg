...
// MFCWinRTDlgDlg.cpp : 実装ファイル
//

#include "pch.h"
#include "framework.h"
#include "MFCWinRTDlg.h"
#include "MFCWinRTDlgDlg.h"
...
CMFCWinRTDlgDlg::CMFCWinRTDlgDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_MFCWINRTDLG_DIALOG, pParent)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
}

void CMFCWinRTDlgDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
}

BEGIN_MESSAGE_MAP(CMFCWinRTDlgDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON1, &CMFCWinRTDlgDlg::OnBnClickedButton1)
	ON_BN_CLICKED(IDC_BUTTON2, &CMFCWinRTDlgDlg::OnBnClickedButton2)
END_MESSAGE_MAP()


// CMFCWinRTDlgDlg メッセージ ハンドラー

BOOL CMFCWinRTDlgDlg::OnInitDialog()
{
...
void CMFCWinRTDlgDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//  システムがこの関数を呼び出します。
HCURSOR CMFCWinRTDlgDlg::OnQueryDragIcon()
{
